...
# Aqui, um novo objeto IPEndPoint é criado. Ele representa o ponto final remoto para uma conexão UDP. Neste caso, o ponto final é definido como o endereço IP 127.0.0.1 (o loopback, ou seja, a própria máquina) na porta 8080.
...
$message = [System.Text.Encoding]::ASCII.GetBytes('hi')

# Aqui, o método Send() do objeto UdpClient é chamado para enviar a mensagem para o ponto final remoto definido anteriormente. Ele recebe como argumentos o array de bytes da mensagem, o comprimento da mensagem e o ponto final remoto.
